...
// Custom theme to match the original styling but without interfering with navbar
const theme = createTheme({
  ...
  // Prevent MUI from affecting global styles
  components: {
    MuiCssBaseline: {
      styleOverrides: {
        // Limit styles to content area only
        '#content-container': {
...
function Content() {
  ...
  return (
    <ThemeProvider theme={theme}>
      {/* Remove CssBaseline to avoid resetting all styles */}
      <div id="content-container" style={{ marginTop: '80px' }}>
        <Container 
          maxWidth="lg" 
          sx={{ 
            py: 4,
            // Make sure container doesn't affect navbar positioning
            position: 'relative',
            zIndex: 1 
          }}
        >
